...
tokencounter = 0
tokencounts = {}
with open(os.path.join("source_tweets.txt"),"r",encoding="utf-8") as tweet_text_file:
...
with open(os.path.join("transposed_label.txt"),"r",encoding="utf-8") as labelfile:
...
BUValids = set(list(tokencounts.keys())[:5000]) # BU has 3229 unique vocabs in her counts..
TDValids = set(list(tokencounts.keys())[:5000]) # TD has 3260 unique vocabs in her counts..
